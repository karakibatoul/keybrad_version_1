...
class AnimatedCategoriesGrid extends StatefulWidget {
  const AnimatedCategoriesGrid({Key? key}) : super(key: key);

  @override
  State<AnimatedCategoriesGrid> createState() => _AnimatedCategoriesGridState();
}

class _AnimatedCategoriesGridState extends State<AnimatedCategoriesGrid> {
  // Items in the list
  final _items = ["Item 0"];
