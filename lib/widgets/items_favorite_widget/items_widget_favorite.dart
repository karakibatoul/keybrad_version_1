...
class ItemsWidgetFavorite extends StatelessWidget {
  const ItemsWidgetFavorite({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    Stack(children: [  Container(
      ...
      Positioned(
        ...
        left: 3.2.h,
          child: Image.asset('assets/icons/favoriteItem.png',height: 35,))
